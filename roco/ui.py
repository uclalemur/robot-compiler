...
#         NodeItem("TimerNodeType", label="Timer Node"),
#         NodeItem("ButtonNodeType", label='Button Node'),
#         NodeItem("IfNodeType", label='If Node'),
#         NodeItem("MotorNodeType", label='Motor Node'),
#         NodeItem("SerialInNodeType", label='Serial In Node'),
#         NodeItem("BlinkLEDNode", label="Blink LED Node"),
#         NodeItem("LogicalNode", label="Logical Node"),
#         NodeItem("MotorNodeType", label="Motor Node"),
#         NodeItem("TestNodeType", label="Test Node"),
#         NodeItem("CustomNodeType", label="Node B"),
#         NodeItem("CustomNodeType", label="Node A"),
#     ])
# ]
